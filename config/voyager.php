...
return [
    /*
    |--------------------------------------------------------------------------
    | Remote databases connections config
    |--------------------------------------------------------------------------
    |
    | Here you can specify supported remote databases connections
    |
    */
...
//        'namespace' => 'TCG\\Voyager\\Http\\Controllers',
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'api-settings'],
        ],
    ],
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            'App\\Widgets\\PlayerDimmer',
//            'App\\Widgets\\BankDimmer',
//            'App\\Widgets\\OrderDimmer',
    ...
    */
    ...
    'googlemaps' => [
         'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyDYQKKcxWa4hTmC1I1JtyapTvVW6c79OGs'),
         'center' => [
             'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '32.05527036053564'),
             'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '34.78502439365229'),
         ],
